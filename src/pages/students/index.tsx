...
export function StudentListPage(props: StudentListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getStudents({
        ...
        searchTermKeys: [
          'name.contains',
          'health_record.contains',
          'academic_record.contains',
          'behavior_record.contains',
        ],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'health_record', header: 'Health Record', accessorKey: 'health_record' },
    { id: 'academic_record', header: 'Academic Record', accessorKey: 'academic_record' },
    { id: 'behavior_record', header: 'Behavior Record', accessorKey: 'behavior_record' },
