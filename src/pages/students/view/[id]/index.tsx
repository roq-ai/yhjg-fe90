          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                ...
                <FormListItem label="Health Record" text={data?.health_record} />

                <FormListItem label="Academic Record" text={data?.academic_record} />

                <FormListItem label="Behavior Record" text={data?.behavior_record} />
