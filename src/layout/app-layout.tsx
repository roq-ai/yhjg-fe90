...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['school-administrator', 'teacher', 'student', 'it-staff'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Fees', path: '/fees', entity: 'fee', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    { name: 'It Staffs', path: '/it-staffs', entity: 'it_staff', service: AccessServiceEnum.PROJECT, icon: FiMonitor },
    { name: 'Students', path: '/students', entity: 'student', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
    { name: 'Teachers', path: '/teachers', entity: 'teacher', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    { name: 'Timetables', path: '/timetables', entity: 'timetable', service: AccessServiceEnum.PROJECT, icon: FiClock },
